...
import { PASSWORD_VALIDATION_PATTERNS_MSGS } from '../../validation/password-validation/password-validation';
...
export class PasswordInputComponent {
  ...
  errorMsgs: ValidationMsg[] = PASSWORD_VALIDATION_PATTERNS_MSGS;
}
